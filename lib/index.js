...
var LabHelper = require('./labHelper');
...
internals.registerLab = function () {
    internals.returnObject.Lab = LabHelper;
    return LabHelper.setup(Chai.expect);
};
...
internals.returnObject.CMD.register.Lab = internals.registerLab;
...
module.exports = function(moduleObject, contraLogOptions) {
    ...
    //internals.exportObject.cl = Contralog(moduleObject, contraLogOptions).off();
